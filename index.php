...
<style>
  ...
  [data-theme="dark"] body { background-color: var(--paper); color: var(--ink); }
  [data-theme="dark"] .app-sidebar, [data-theme="dark"] .app-topbar, [data-theme="dark"] .panel, [data-theme="dark"] .kpi-card, [data-theme="dark"] .content-panel { background-color: var(--panel); border-color: var(--rule); color: var(--ink); }
  [data-theme="dark"] .topbar-title, [data-theme="dark"] .brand-title, [data-theme="dark"] .kpi-value { color: var(--ink); }
  [data-theme="dark"] .sidebar-item { color: var(--muted); }
  [data-theme="dark"] .sidebar-item:hover { background-color: var(--rule); color: var(--ink); }
  [data-theme="dark"] .table { color: var(--ink); border-color: var(--rule); }
  [data-theme="dark"] .table th { background-color: #0F172A; color: var(--muted); border-color: var(--rule); }
  [data-theme="dark"] .table td { background-color: var(--panel); border-color: var(--rule); }
  [data-theme="dark"] .modal-content, [data-theme="dark"] .swal2-popup { background-color: var(--panel) !important; color: var(--ink) !important; }
  [data-theme="dark"] .swal2-title, [data-theme="dark"] .swal2-html-container { color: var(--ink) !important; }
  [data-theme="dark"] .form-control, [data-theme="dark"] .form-select, [data-theme="dark"] .swal2-input { background-color: #0F172A !important; border-color: var(--rule) !important; color: var(--ink) !important; }
  ...
  return `
    ...
    <aside class="app-sidebar ${state.mobileNav ? 'show' : ''}">
      ...
      <div class="sidebar-footer" style="display:flex;gap:8px;">
        <button class="logout-btn" onclick="toggleTheme()" title="Toggle Dark Mode" style="width:42px;padding:0;font-size:16px;">🌙</button>
