      ...
      <div class="panel emp-card mb-2" style="padding:14px 18px;">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
          ...
          <div class="d-flex align-items-center gap-2 flex-wrap">
            ...
            ${c.phone ? `<button class="btn btn-sm btn-success fw-bold px-2 py-1" style="font-size:12px;" data-act="wa-direct" data-phone="${c.phone}" data-name="${c.name}" data-due="${pendingDue}" title="Send WhatsApp Statement">📱 WA</button>` : ''}
